...
<?php if(empty($_SESSION['username'])): ?>
    ...
    <!-- If Google user signed - Patient -->
        <?php elseif($_SESSION['myrole']==1): ?>
            <br/>
            <?php if(isset($_GET['p']) && $_GET['p']=='videos'): ?>
            <div class='videosf'>
            <br/>
            <?php include 'therapy.php';?>
            <br/>
            ...
            <div>
            <p align="left">Below are videos of recommended exercises.</p>
            
            <br/><br/>
            <iframe width="1000" height="529"  src="https://www.youtube.com/embed/videoseries?list=PLHfSIOVDaOI9CaU9JuWSqstI4takdx7mQ" allowfullscreen></iframe>
            </div>
            </div>
            <?php else:?>
